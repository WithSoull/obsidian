# Рабочие материалы по концепции ВКР

## Краткое резюме рецензии
...
# Проработанная концепция ВКР

Ниже приведена формулировка, которую уже можно показывать научному руководителю.
...
# Модель стоимости для self-hosted-системы

Здесь смешиваются три разных понятия: **денежная стоимость**, **занятое место** и **нагрузка на накопитель**. Для ВКР их лучше разделить.
