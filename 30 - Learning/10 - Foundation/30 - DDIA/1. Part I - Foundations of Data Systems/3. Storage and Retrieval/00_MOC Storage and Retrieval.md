...
Так называемые [[30 - Learning/10 - Foundation/30 - DDIA/1. Part I - Foundations of Data Systems/3. Storage and Retrieval/02.Data structers that power your database/Индексы в базах данных|Индексы в базах данных]], котоыре ускоряют чтение, но замедляют запись, могут содержать в себе разные структуры данных.

## Какие бывают нагрузки?
У нас бывает [[30 - Learning/10 - Foundation/30 - DDIA/1. Part I - Foundations of Data Systems/3. Storage and Retrieval/03.OLAP/OLTP vs OLAP. И что это вообще такое?|два вида нагрузки]]:
1) OLAP - аналитика
2) OLTP - транзакции