### Предисловие
Это еще один бинарный формат кодирования данных, изначльно был проектом **Hadoop**, так как *thrift* не особо подходил под их требования. Механизм с [[public/30 - Learning/10 - Foundation/30 - DDIA/5 - Encoding and Evolution/1 - Formats/Avro/Writers & Readers in Avro|writers & readers]] и [[public/30 - Learning/10 - Foundation/30 - DDIA/5 - Encoding and Evolution/1 - Formats/Avro/Dynamically Generated Schemas in Avro|динамически-сгенерированные схемы]] это то, что отличает Avro от остальных форматов.
