...
- [[public/30 - Learning/10 - Foundation/30 - DDIA/6 - Replication/0 - Single-leader/Setting up New Replicas|Поднятие(наливка) новой реплики]]
- [[public/30 - Learning/10 - Foundation/30 - DDIA/6 - Replication/0 - Single-leader/Handling Node Outages|Обработка отказов реплик]]
