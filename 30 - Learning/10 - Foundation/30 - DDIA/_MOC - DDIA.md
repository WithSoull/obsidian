...
### 8. Transactions
Папка **создана**, но содержимое пока не разложено.
...
- Рядом лежит [[public/30 - Learning/10 - Foundation/30 - DDIA/Why Distribute Data Across Machines|Why Distribute Data Across Machines]] -- ee надо куда-нибудь внедрить. Осталась с DDIA 1.0
