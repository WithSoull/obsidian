...
1) Конкурентность
2) [[30 - Learning/10 - Foundation/30 - DDIA/1 - Part I - Foundations of Data Systems/3 - Storage and Retrieval/02 - Data Structures That Power Your Database/Сегментация логов для движка базы данных|Сегментация логов для движка базы данных]]
...
Чтобы решить эту проблему мы можем использвать [[30 - Learning/10 - Foundation/30 - DDIA/1 - Part I - Foundations of Data Systems/3 - Storage and Retrieval/02 - Data Structures That Power Your Database/Индексы в базах данных|индексы]], которые ускоряют чтение, но замедляют запись.