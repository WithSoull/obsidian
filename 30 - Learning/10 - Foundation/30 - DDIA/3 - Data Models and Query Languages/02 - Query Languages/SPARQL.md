**SPARQL** — язык запросов для [[public/30 - Learning/10 - Foundation/30 - DDIA/3 - Data Models and Query Languages/01 - Data Models/03 - Graph/Triple-Store Model|triple-store]] с [[public/30 - Learning/10 - Foundation/30 - DDIA/3 - Data Models and Query Languages/01 - Data Models/03 - Graph/Semantic Web & RDF|RDF]] моделью данных. Расшифровывается как **SPARQL Protocol and RDF Query Language**.
## Связь с [[public/30 - Learning/10 - Foundation/30 - DDIA/3 - Data Models and Query Languages/02 - Query Languages/Cypher|Cypher]]
