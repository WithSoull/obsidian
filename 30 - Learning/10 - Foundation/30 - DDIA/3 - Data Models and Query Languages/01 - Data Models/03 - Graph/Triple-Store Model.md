Это одна из вариаций графовой модели данных, похожа на [[public/30 - Learning/10 - Foundation/30 - DDIA/3 - Data Models and Query Languages/01 - Data Models/03 - Graph/Property Graph Model|Property-graph model]], но тем не менее имеет некоторые отличия.
### Структура
1) subject
2) predicate
3) object
...
### Semantic Web | RDF
Легко перемутать это все вместе, подробно описано [[public/30 - Learning/10 - Foundation/30 - DDIA/3 - Data Models and Query Languages/01 - Data Models/03 - Graph/Semantic Web & RDF|тут]].
Если кратко, Semantic Web это попытка принудить сайты публиковать данные в машиночитаемом формате, але база знаний всего. А RDF это *Resourse Description Framework*. Все это дело не прижилось. Но в популярном языке запросов [[public/30 - Learning/10 - Foundation/30 - DDIA/3 - Data Models and Query Languages/02 - Query Languages/SPARQL|SPARQL]] в основе лежит этот RDF.
