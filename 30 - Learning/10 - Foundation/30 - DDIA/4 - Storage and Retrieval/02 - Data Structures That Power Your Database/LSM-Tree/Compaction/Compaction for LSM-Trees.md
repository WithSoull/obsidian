...
| [[30 - Learning/10 - Foundation/30 - DDIA/1 - Part I - Foundations of Data Systems/3 - Storage and Retrieval/02 - Data Structures That Power Your Database/LSM-Tree/Compaction/Leveled Compaction for LSM-Tree|LC]]      | Низкая             | Высокая             | Низкая, нет повторяющихся ключей              | Для read-heavy нагрузок                                           | LevelDB, RocksDB, Cassandra |
