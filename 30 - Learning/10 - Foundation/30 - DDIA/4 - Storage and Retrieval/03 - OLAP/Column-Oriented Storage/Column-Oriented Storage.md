...
Если у вас трилионы записей и ПБ данных в вашей *fact* таблице в [[public/30 - Learning/10 - Foundation/30 - DDIA/4 - Storage and Retrieval/03 - OLAP/Data Warehousing|DWH]], то эфеективные запросы становяться проблемой.
...
Помимо того, что мы таким расположением данных решаем проблему эффективности запросов, у нас теперь тут есть огромный [[public/30 - Learning/10 - Foundation/30 - DDIA/4 - Storage and Retrieval/03 - OLAP/Column-Oriented Storage/Column Compression in Column-Oriented Databases|простор для сжатия]], ведь это тоже немаловажный факт.
